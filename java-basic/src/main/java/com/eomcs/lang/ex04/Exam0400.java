...
public class Exam0400 {
  public static void main(String[] args) {
    ...
    //- 논리
    boolean bool; // 자바 언어 명세서에는 논리 메모리의 크기가 정의되어 있지 않다. 다만 JM 명세서에는 int로 다룬다고 나와있다.
...
//   - double : 8byte메모리 (유효자릿수 15자리)

//  - 문자
//   - char : 2byte 메모리 (0~65535), USC-2 코드 값 저장.
//  - 논리값
//   - boolean : JVM에서 4바이트 int 메모리를 사용한다.
//               배열일 경우 1바이트 byte 메모리를 사용한다.
//
//  2) reference(레퍼런스)
